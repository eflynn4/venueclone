...
export default function LogInPage() {
    return (
        ...
        <div className="relative w-fit min-w-md h-fit flex flex-col items-center justify-center rounded-2xl bg-white mt-12 p-12">
            <h1 className="w-full text-left text-4xl font-bold text-black">Log In</h1>
            ...
            <form className="mt-8 w-full space-y-4">
                ...
                <div className="flex flex-row">
                    ...
                    <Link href="/forgot-password" className="ml-auto text-[var(--color-navyblue)] hover:text-[var(--color-navyblue-light)] hover:underline">
                        Forgot Password?
                    </Link>
                </div>
                <button
                ...
                <p className="text-center text-gray-700">
                    ...
                    <Link href="/signup" className="text-[var(--color-navyblue)] hover:text-[var(--color-navyblue-light)] hover:underline">
                        Sign Up
                    </Link>
                </p>
            </form>
