      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 pb-16 pt-10">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-[280px_1fr]">
          <aside className="space-y-6">
            <HeroSearchBar
              initialQuery={initialQuery}   // ✅ (optional, only if your HeroSearchBar uses it)
              widthClass="w-full"
              heightClass="h-[60px]"
          ...
          <section className="rounded-2xl bg-white p-6 shadow-xl">
              ...
              <div className="flex-1">
                ...
                <div className="mt-5 grid grid-cols-1 gap-3 sm:grid-cols-3">
                  ...
                  <div className="rounded-2xl bg-slate-50 p-4">
                    ...
                    <div className="mt-1 text-lg font-extrabold text-slate-900">{venue.type}</div>
                  </div>
                  <div className="rounded-2xl bg-slate-50 p-4">
            ...
            <div className="mt-8 border-t pt-6">
              ...
              <p className="mt-3 whitespace-pre-line text-slate-700">
                {venue.description?.trim() ? venue.description : "No description available yet."}
              </p>
            </div>
